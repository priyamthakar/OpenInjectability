...
**Public version:** 0.1.0 alpha on [PyPI](https://pypi.org/project/openinjectability/0.1.0/)
...
| Standalone arithmetic cross-implementation (imports no package code) | [`validation/independent_reference.py`](validation/independent_reference.py) | `tests/test_core.py::test_standalone_cross_implementation_matches_core` |
...
| Synthetic scientist workflow (software acceptance only; not validation evidence) | `examples/formulation_screening.csv`; `docs/formulation-screening-example.md` | `tests/test_cli.py::test_synthetic_formulation_screening_workflow` |
| Complete reports, four plot classes, provenance, rejected rows and audit contents | generated fixture artifacts | `tests/test_cli.py::test_complete_report_plot_and_audit_artifact_set`, `tests/test_io_and_edges.py::test_cli_preserves_valid_rows_and_records_rejected_rows` |
| Positive-domain, monotonicity, JSON-finiteness and time/flow properties | Hypothesis-generated cases | `tests/test_properties.py` |
...
The requirement-level evidence ledger is [COMPLETION_AUDIT.md](COMPLETION_AUDIT.md).
