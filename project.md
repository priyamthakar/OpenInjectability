...
- [ ] **D** independent experimental validation (external evidence) — blocked without external Newtonian dataset + pre-locked protocol
- [ ] **E** public release — blocked until D and publish credentials
