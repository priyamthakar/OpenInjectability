...
| Doc | Purpose |
|---|---|
| [../PROJECT_GOAL.md](../PROJECT_GOAL.md) | Definition of complete |
| [../PROJECT_SPECIFICATION.md](../PROJECT_SPECIFICATION.md) | Full product/scientific spec |
| [../project.md](../project.md) | Full project plan + work tracker |

## Literature / Phase D research archive

These record scrape/PDF work; they are **not** independent validation claims.

| Doc | Purpose |
|---|---|
| [pdf-ingestion-2026-08-02.md](pdf-ingestion-2026-08-02.md) | User PDF ingestion + Allmendinger panel |
| [literature-scrape-assessment.md](literature-scrape-assessment.md) | Why total glide force ≠ fluid force |
| [multi-agent-pubmed-consensus.md](multi-agent-pubmed-consensus.md) | Multi-agent PubMed sweep |
| [papers-to-fetch.md](papers-to-fetch.md) | DOI shopping list |
| [agent-*.md](./) | Individual agent hunt reports |
