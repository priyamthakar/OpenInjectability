...
| D — independent experimental validation | **Literature panel run (digitized)** | Allmendinger 2014 PDFs ingested; Table 1 exact + Fig. 3(A) digitized glycerol panel (12 rows); median \|rel err\| ≈ 13.5% → experimental_comparison **pass** vs 20% criterion; **not** independently_validated (digitization caveats); see `docs/pdf-ingestion-2026-08-02.md` |
